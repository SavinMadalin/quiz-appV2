...
import { CalendarIcon, ChartPieIcon, ClockIcon, CpuChipIcon, ArrowUpIcon, ArrowDownIcon, ChatBubbleLeftRightIcon } from '@heroicons/react/24/outline';

const HistoryTable = ({ sortedHistory, sortConfig, requestSort, handleSeeFeedback }) => {
      ...
      <div className="mb-4 p-2 rounded-lg shadow-md border border-gray-300 dark:border-gray-700 max-h-[250px] overflow-y-auto">
        ...
        <div className="flex flex-col gap-2 mt-2">
          {sortedHistory.map((result, index) => {
            ...
            const isPassed = result.quizType === 'interview' ? percentage >= 66 : percentage >= 80; // Changed the percentage for interview
